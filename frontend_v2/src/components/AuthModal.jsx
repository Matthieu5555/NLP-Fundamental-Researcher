...
function AuthModal({ isOpen, onClose, initialMode = 'login' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-surface-elevated rounded-lg border shadow-lg p-8 mx-4 w-full max-w-md">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-tertiary text-sm mt-1">Your LLM Intern</p>
        </div>
