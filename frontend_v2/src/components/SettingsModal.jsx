...
export default function SettingsModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="bg-surface-elevated rounded-lg shadow-lg border w-full max-w-2xl mx-4 max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="border-b bg-surface-secondary px-6 py-4 flex-shrink-0">
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 py-2 border border-medium rounded-lg text-sm focus:ring-2 focus:ring-brand focus:border-brand resize-none"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-medium rounded-lg text-sm focus:ring-2 focus:ring-brand focus:border-brand"
                    >
                      {MODELS.map((model) => (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-2 bg-surface-card-hover rounded-lg appearance-none cursor-pointer accent-brand"
                    />
                ...
                <div className="space-y-4">
                      ...
                      <button
                        ...
                        className={`px-4 py-2 text-sm rounded-lg border transition-colors ${
                          formState.theme === 'light'
                            ...
                            : 'bg-surface-elevated border-medium text-secondary hover:border-heavy'
                        }`}
                      >
                        Light
                      </button>
                  ...
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 text-brand border-medium rounded focus:ring-brand"
                    />
        ...
        {/* Footer */}
        <div className="border-t bg-surface-secondary px-6 py-4 flex justify-between items-center flex-shrink-0">
          <button
            onClick={handleReset}
            disabled={saving}
