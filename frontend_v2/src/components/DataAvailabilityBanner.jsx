...
export default function DataAvailabilityBanner({ companyInfo }) {
  ...
  return (
    <div className="bg-accent-warning-light border border-accent-warning rounded-lg p-4 mb-6">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h4 className="text-sm font-semibold text-accent-warning-dark">
            Limited Data Available for Non-US Company
          </h4>
          <p className="text-sm text-accent-warning-dark mt-1">
            {companyInfo.company_name || companyInfo.ticker} is classified as a non-US company.
            Some premium data sources are not available:
          </p>
          <ul className="mt-2 text-sm text-accent-warning-dark space-y-1">
          ...
          <p className="text-xs text-accent-warning mt-3">
            Analysis will use publicly available data from Yahoo Finance and web research.
          </p>
        </div>
        <div className="flex-shrink-0">
          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-accent-warning-light text-accent-warning-dark">
